...
public class Vet15 {
 ...
 double [] temperatura = new double [366]; // tamanho ou posições
   ...
   System.out.println("O valor da temperatura do dia 1 é:" + temperatura[4]);
   ...
   for (double temp: temperatura) {
	   ...
	   // A diferença entre for normal e melhorando, o normal temos mais detalhe atraves do i, consiguimos saber os numeros de vezes q ele passa , ao passo no melhorando apenas imprimimos
   }
	}
